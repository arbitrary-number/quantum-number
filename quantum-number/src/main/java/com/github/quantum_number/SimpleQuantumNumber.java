...
public class SimpleQuantumNumber {
    ...
    public static final String[] ORDINAL_NAMES = {"a", "b", "c", "d", "e", "f", "g", "h", "i",
    		"j", "k", "l"};

    /**
     * Default constructor - creates a zero Quantum Number
     */
    public SimpleQuantumNumber() {
     ...
     */
    public SimpleQuantumNumber(int[] ordinals, boolean[] signs) {
     ...
     * Copy constructor
     */
    public SimpleQuantumNumber(SimpleQuantumNumber other) {
     ...
     */
    public static SimpleQuantumNumber zero() {
        SimpleQuantumNumber zero = new SimpleQuantumNumber();
        for (int i = 0; i < NUM_ORDINALS; i++) {
            zero.setOrdinal(i, 0);
        }
        zero.updateChecksum();
     ...
     */
    public static SimpleQuantumNumber one() {
        SimpleQuantumNumber one = new SimpleQuantumNumber();
     ...
     */
    public SimpleQuantumNumber add(SimpleQuantumNumber other) {
     ...
     */
    public SimpleQuantumNumber subtract(SimpleQuantumNumber other) {
        SimpleQuantumNumber negated = other.negate();
     ...
     */
    public SimpleQuantumNumber negate() {
        SimpleQuantumNumber result = new SimpleQuantumNumber(this);
        for (int i = 0; i < NUM_ORDINALS; i++) {
    ...
    public String toString() {
        ...
        sb.append("  Structure: (±a ± g) / (±b ± g) / (±c ± h) / ((±d(±b ± h)) / (±e(±i ± )) / (±fb(±j)))\n");
        sb.append("  Expanded: ");
     ...
     */
    public SimpleQuantumNumber getRealComponent() {
        SimpleQuantumNumber real = new SimpleQuantumNumber(this);
     ...
     */
    public static SimpleQuantumNumber createComplex(SimpleQuantumNumber real, int imaginary) {
        SimpleQuantumNumber complex = new SimpleQuantumNumber(real);
     ...
     */
    public static SimpleQuantumNumber createComplex(int real, int imaginary) {
        SimpleQuantumNumber complex = new SimpleQuantumNumber();
     ...
     */
    public SimpleQuantumNumber multiplyComplex(SimpleQuantumNumber other) {
     ...
     */
    public SimpleQuantumNumber divideComplex(SimpleQuantumNumber other) {
     ...
     */
    public SimpleQuantumNumber conjugate() {
        SimpleQuantumNumber result = new SimpleQuantumNumber(this);
     ...
     */
    public SimpleQuantumNumber multiply(SimpleQuantumNumber other) {
     ...
     */
    public SimpleQuantumNumber divide(SimpleQuantumNumber other) {
        // Check for division by zero
        if (other.isZero()) {
     ...
     */
    public SimpleQuantumNumber power(int exponent) {
        if (exponent == 0) {
            return SimpleQuantumNumber.one();
        }
        if (exponent == 1) {
            return new SimpleQuantumNumber(this);
        }
        if (exponent < 0) {
            throw new IllegalArgumentException("Negative exponents not supported in this implementation");
        }

        SimpleQuantumNumber result = SimpleQuantumNumber.one();
        SimpleQuantumNumber base = new SimpleQuantumNumber(this);
     ...
     */
    public SimpleQuantumNumber complexPower(int exponent) {
        if (exponent == 0) {
    ...
    public boolean equals(Object obj) {
        ...
        SimpleQuantumNumber other = (SimpleQuantumNumber) obj;
